...
last_names = ['的', '一', '是', '了', '我', '不', '人', '在', '他', '有', '这', '个', '上', '们', '来', '到', '时', '大', '地', '为',
                   ...
                   '乾', '坤']
address = ['谢营', '化肥厂', '官庄', '肖坡', '小刘', '大刘', '何上寨', '李庄', '路马庄' ,'胡岗' ,'乔洼' ,'吴庄' ,'孙洼' ,'大营' ,'小营']
phone_1_3 = ['134','135','136','150','137','151','158','159','157','186','189','188','183','185','186']

def get_name():
    return ''.join([ rd.choice(first_names), rd.choice(last_names), rd.choice(last_names)])

def get_address():
    return rd.choice(address)

def get_phone():
    phone_last = rd.randint(12345678, 99999999)
    tsr = ''.join([rd.choice(phone_1_3), str(phone_last)])
    return tsr
...
def get_date():
    sec1 = 1480000000
    sec2 = 1499990000
    sec = rd.randint(sec1, sec2)

    time_st = time.localtime(sec)
    return dt.date(time_st.tm_year, time_st.tm_mon, time_st.tm_mday)


#*********************************************************************
def get_huos():
    huos = [
        (102, u'竹圈', 0.02, 100, 1, 0, '2017-01-11' ,u'世界美好' ),
        (103, u'包装无蜡', 0.05, 100, 1, 0, '2017-02-13', u'界美好' ),
        (104, u'粘纸', 0.08, 100, 1, 0, '2017-03-13' ,u'美好' ),
        (106, u'包装', 0.06, 100, 1, 1, '2017-04-14' ,u'好' )
    ]
    return huos
...
if __name__ == '__main__':
    ...
    testSql.insert(_sql.SQL_HUO.INSERT, get_huos())
