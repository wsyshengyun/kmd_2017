...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.clook_sum = QPushButton(Dialog)
        ...
        QObject.connect(self.clook_sum, SIGNAL(_fromUtf8("clicked()")), Dialog.slot_btn_clicked)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.clook_sum.setText(_translate("Dialog", "收发总计", None))
